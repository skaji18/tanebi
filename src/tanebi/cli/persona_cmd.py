...
def add_persona_parser(subparsers: argparse._SubParsersAction) -> None:
    ...
    persona_parser = subparsers.add_parser("persona", help="Manage personas")
    ...
    copy_p = persona_sub.add_parser("copy", help="Copy a persona")
    copy_p.add_argument("src", help="Source persona ID")
    copy_p.add_argument("dst", help="Destination persona ID")
    copy_p.set_defaults(func=_persona_copy)

    # persona merge <base> <donor> [--output <out>]
    merge_p = persona_sub.add_parser("merge", help="Merge two personas")
    merge_p.add_argument("base", help="Base persona ID")
    merge_p.add_argument("donor", help="Donor persona ID")
    merge_p.add_argument("--output", help="Output persona ID (defaults to {base}_x_{donor})")
